...
namespace StratusQuo
{
    ...
    inline constexpr int8_t LEFT_MOTOR_BACK_PORT (5);
    inline constexpr int8_t LEFT_MOTOR_MID_PORT (-3);
    inline constexpr int8_t LEFT_MOTOR_FRONT_PORT (-8);
    inline constexpr int8_t RIGHT_MOTOR_BACK_PORT (-1);
    inline constexpr int8_t RIGHT_MOTOR_MID_PORT (2);
    inline constexpr int8_t RIGHT_MOTOR_FRONT_PORT (11);
    
    inline std::vector<int8_t> left_motor_ports = {LEFT_MOTOR_BACK_PORT, LEFT_MOTOR_MID_PORT, LEFT_MOTOR_FRONT_PORT};
    inline std::vector<int8_t> right_motor_ports = {RIGHT_MOTOR_BACK_PORT, RIGHT_MOTOR_MID_PORT, RIGHT_MOTOR_FRONT_PORT};
    ...
    inline constexpr uint8_t IMU_PORT (13);
    ...
    inline constexpr bool JACKS_INIT_STATE (false);
