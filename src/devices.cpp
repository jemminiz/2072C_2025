...
pros::ADIDigitalOut intakeRaise('E');
pros::ADIDigitalOut leftDoinker('F');
...
pros::Motor leftMiddle(4, pros::E_MOTOR_GEARSET_06, true); 
pros::Motor leftBack(18, pros::E_MOTOR_GEARSET_06, false); 
pros::Motor rightFront(1, pros::E_MOTOR_GEARSET_06, false); 
pros::Motor rightMiddle(2, pros::E_MOTOR_GEARSET_06, false); 
pros::Motor rightBack(3, pros::E_MOTOR_GEARSET_06, true); 
...
void checkMotorsAndPrintTemperature() {
    std::vector<pros::Motor> motors = {
      leftFront, leftBack, leftMiddle, rightFront, rightBack, rightMiddle, hooks, rollers, wallStake
    };
